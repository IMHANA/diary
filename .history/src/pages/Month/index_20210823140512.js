...
class Month extends Component {
  ...
  render() {
    ...
    // this.state.i_num_arr =

    // this.i_num_arr.forEach((val) => {
    //   list.push(
    ...
    return (
      <div id="container">
        ...
        <div className="month_box_container first-floor">
          {this.state.i_num_arr.map((val) => {
            this.state.sticker.forEach((sti) => {
              const month = sti.ds.substring(5, 7);
              console.log(month);
              if (month === val) {
                return (
                  <div className="calendar-item">
